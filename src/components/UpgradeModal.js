...
const CONTENT = {
  materi: {
    ...
    desc: "Kamu sudah mengerjakan 200 soal gratis (total lintas semua materi). Progress kamu tetap tersimpan — upgrade ke Premium untuk membuka seluruh bank soal tanpa batas di semua materi.",
  },
  cat_quota: {
    emoji: "🎯",
